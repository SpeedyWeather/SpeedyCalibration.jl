...
#
# This script (weight=0.6) and its sibling trenberth_bd2_lrdweight04.jl (weight=0.4)
...
result = calibrate!(
    ...
    save_dir = joinpath(@__DIR__, "output/trenberth_bd2_lrdweight06"),
)
