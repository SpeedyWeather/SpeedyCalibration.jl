...
#
# This script (weight=0.8) and its sibling trenberth_bd2_lrdweight04.jl (weight=0.4)
...
# TRENBERTH_LOSS with lrd's weight raised 0.3 -> 0.6 (brackets the confirmed-good
# 0.5 from above). Everything else identical to TRENBERTH_LOSS.
...
result = calibrate!(
    ...
    save_dir = joinpath(@__DIR__, "output/trenberth_bd2_lrdweight08"),
)
